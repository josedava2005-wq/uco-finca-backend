...
public class ProductoEntidad {
    ...
    public ProductoEntidad(final UUID id, final String nombre, final String unidadMedida, final Double precioUnitario, final Double stockDisponible, final String descripcion, final FincaEntidad finca) {
        this.id = id;
        this.nombre = nombre;
