...
public class AnimalEntidad {
    ...
    public AnimalEntidad(final UUID id, final String nombre, final String especie, final String raza, final String sexo, final String fechaNacimiento, final Double pesoKg, final FincaEntidad finca) {
        this.id = id;
        this.nombre = nombre;
