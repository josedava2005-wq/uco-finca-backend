...
@Repository
public class CompraDatosImpl implements CompraDatos {

    private static final List<CompraEntidad> almacen = new ArrayList<>();

    @Override
    public void crear(final CompraEntidad entidad) {
        almacen.add(entidad);
    }

    @Override
    public List<CompraEntidad> consultar(final CompraEntidad filtro) {
        return new ArrayList<>(almacen);
    }

    @Override
    public void modificar(final CompraEntidad entidad) {
