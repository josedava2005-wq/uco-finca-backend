...
public final class TipoAlmacenDominio {

    private UUID id;
    private String nombre;
    private String descripcion;

    private TipoAlmacenDominio(final Builder builder) {
        setId(builder.id);
    ...
    public static final class Builder {
        ...
        public TipoAlmacenDominio build() { return new TipoAlmacenDominio(this); }
    }
}
